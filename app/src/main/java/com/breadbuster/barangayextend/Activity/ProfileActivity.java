...
import com.breadbuster.barangayextend.Fragments.BasicInformationFragment;
import com.breadbuster.barangayextend.Fragments.PostOfLoggedInUserFragment;
...
public class ProfileActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        FloatingActionButton fab_post = findViewById(R.id.fab_post);
    ...
    public class SectionsPagerAdapter extends FragmentPagerAdapter {
        ...
        public Fragment getItem(int position) {
            ...
            switch(position){
                ...
                case 1:
                    PostOfLoggedInUserFragment postOfLoggedInUserFragment = new PostOfLoggedInUserFragment();
                    return postOfLoggedInUserFragment;
            }
