...
public class PendingFragment extends Fragment {
    @InjectView(R.id.recyclerView_pending) RecyclerView recyclerView_pending;
    @InjectView(R.id.swipeToRefresh_pending) SwipeRefreshLayout swipeToRefresh_pending;
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        try{
            ...
            recyclerView_pending.setLayoutManager(new LinearLayoutManager(getActivity().getApplicationContext()));

            listOfRequestPosition = new ArrayList<>();

            showAllRequestPosition();

            swipeToRefresh_pending.setColorSchemeResources(R.color.colorPrimary);

            swipeToRefresh_pending.setOnRefreshListener(new SwipeRefreshLayout.OnRefreshListener() {
                @Override
                public void onRefresh() {
                    ...
                    showAllRequestPosition();
                    swipeToRefresh_pending.setRefreshing(false);
                }
            });
        }catch (Exception ex){
    ...
    private void showAllRequestPosition(){
        try{
            ...
            CacheRequest request = new CacheRequest(null, Request.Method.POST, url.getShowAllRequestBasedOnStatus() + "Pending&requesterBarangay=" + HomeActivity.userBarangay + "&requestedPosition=" + HomeActivity.userType,
                        ...
                        public void onResponse(NetworkResponse response) {
                            ...
                            try {
                                ...
                                if(jsonString.equalsIgnoreCase("no_data")){
                                    ...
                                    recyclerView_pending.setAdapter(adapter_emptyRecyclerView);
                                }else{
                                    ...
                                    recyclerView_pending.setAdapter(adapter);
                                }
