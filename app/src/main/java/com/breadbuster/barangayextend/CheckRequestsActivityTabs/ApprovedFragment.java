...
public class ApprovedFragment extends Fragment {
    @InjectView(R.id.recyclerView_approved) RecyclerView recyclerView_approved;
    @InjectView(R.id.swipeToRefresh_approved) SwipeRefreshLayout swipeToRefresh_approved;
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        try{
            ...
            recyclerView_approved.setLayoutManager(new LinearLayoutManager(getActivity().getApplicationContext()));

            listOfRequestPosition = new ArrayList<>();

            showAllRequestPosition();

            swipeToRefresh_approved.setColorSchemeResources(R.color.colorPrimary);

            swipeToRefresh_approved.setOnRefreshListener(new SwipeRefreshLayout.OnRefreshListener() {
                @Override
                public void onRefresh() {
                    ...
                    showAllRequestPosition();
                    swipeToRefresh_approved.setRefreshing(false);
                }
            });
        }catch (Exception ex){
    ...
    private void showAllRequestPosition(){
        try{
            ...
            CacheRequest request = new CacheRequest(null, Request.Method.POST, url.getShowAllRequestBasedOnStatus() + "Approved&requesterBarangay=" + HomeActivity.userBarangay + "&requestedPosition=" + HomeActivity.userType,
                        ...
                        public void onResponse(NetworkResponse response) {
                            ...
                            try {
                                ...
                                if(jsonString.equalsIgnoreCase("no_data")){
                                    ...
                                    recyclerView_approved.setAdapter(adapter_emptyRecyclerView);
                                }else{
                                    ...
                                    recyclerView_approved.setAdapter(adapter);
                                }
